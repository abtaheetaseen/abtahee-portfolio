  ...
  return (
    <div className='bg-gray-100 min-h-[70vh] flex items-center justify-center'>
      <div className='text-center'>
        ...
        <p className='w-7/12 mx-auto my-3 text-yellow-600'>REACT DEVELOPER | <span className='text-black'>I'm available to build your website if you're looking for a web developer.</span></p>
